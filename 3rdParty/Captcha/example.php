      ...
      if ($goto == 'form')
      {
        ...
        ?>
          ...
          <form action="<?php echo $_SERVER['PHP_SELF']; ?>?goto=login" method="post">
            ...
            <img style="background-color:#e2e2e2;padding:5px;border:1px solid #eee;" src="./captcha.php?.png" alt="CAPTCHA" />

            <br />

            <input type="text" name="captchastring" size="5" /> <em style="font-size:10px;color:grey;">(cAse SeNSItivE!)</em>
